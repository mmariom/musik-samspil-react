                    ...
                    <div className="card mb-5">
                        <div className="card-body d-flex flex-column align-items-center">
                            ...
                            <form className="text-center" method="post">
                                <div className="mb-3"><input className="form-control" type="text" placeholder="Full Name" name="fullname"/></div>
                                ...
                                <div className="mb-3"><input className="form-control" type="text" placeholder="Phone no" name="phoneno"/></div>
